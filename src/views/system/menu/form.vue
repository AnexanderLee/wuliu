<template>
  <el-dialog :visible.sync="dialog" :title="isAdd ? '新增菜单' : '编辑菜单'" append-to-body width="600px" @close="cancel">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item label="菜单后缀" prop="suffix">
        <el-input v-model.trim="form.suffix" placeholder="后缀可为空" style="width: 460px;"/>
      </el-form-item>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="菜单可见" prop="menuEnable">
            <el-radio-group v-model="form.menuEnable" size="mini">
              <el-radio-button label="true">是</el-radio-button>
              <el-radio-button label="false">否</el-radio-button>
            </el-radio-group>
          </el-form-item>
        ...
        <el-col :span="8">
          <el-form-item label="菜单缓存" prop="menuRefresh">
            <el-radio-group v-model="form.menuRefresh" size="mini">
              <el-radio-button label="true">是</el-radio-button>
              <el-radio-button label="false">否</el-radio-button>
            </el-radio-group>
          </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      form: { id: null, name: '', suffix: '', sort: 999, path: '', component: '', iframe: 'false', menuEnable: 'true', menuRefresh: 'true', roles: [], pid: 0, icon: '' },
      rules: {
        name: [
  ...
  methods: {
    ...
    resetForm() {
      ...
      this.form = { id: null, name: '', suffix: '', sort: 999, path: '', component: '', iframe: 'false', menuEnable: 'true', menuRefresh: 'true', roles: [], pid: 0, icon: '' }
    },
    selected(name) {
      this.form.icon = name
    },

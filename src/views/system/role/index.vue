      ...
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="17">
        <el-card
          ...
          <el-table
            ...
            <el-table-column prop="dataScope" label="数据权限" width="70"/>
            <el-table-column prop="level" label="角色级别" width="70"/>
            <el-table-column :show-overflow-tooltip="true" prop="remark" label="描述"/>
            <el-table-column :show-overflow-tooltip="true" prop="createTime" label="创建日期" width="90">
...
import { del, editMenu, editPermission, get } from '@/api/role'

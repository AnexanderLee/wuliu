<template>
  <el-dialog :visible.sync="dialog" append-to-body title="执行日志" width="88%">
    ...
    <el-table
      ...
      :data="data"
      size="small"
      style="width: 100%;margin-top: -10px;border-radius: 0 0 8px 8px;
    box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.1)">
      <el-table-column :show-overflow-tooltip="true" prop="jobName" label="任务名称" align="center"/>
      <el-table-column :show-overflow-tooltip="true" prop="beanName" label="Bean名称" align="center"/>
      <el-table-column :show-overflow-tooltip="true" prop="methodName" label="执行方法" align="center"/>
      <el-table-column :show-overflow-tooltip="true" prop="params" width="120px" label="参数" align="center"/>
      <el-table-column :show-overflow-tooltip="true" prop="cronExpression" label="cron表达式" align="center"/>
      <el-table-column prop="createTime" label="异常详情" width="110px" align="center">

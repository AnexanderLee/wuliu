...
export default {
  ...
  methods: {
    beforeInit() {
      this.url = '/api/wuliu/queryDcyResetInfo'
      ...
      this.$router.push({
        ...
        query: {
          data: JSON.stringify({
            ...
            operate: 5 // 1=竞价 2=新增竞价 3=编辑竞价 4=参与竞价与参与记录查看 5=重新竞价申请查看 6=编辑竞价申请查看 7=取消业务查看
          })
        }
      })
    },
    doCancel(row) {
      this.$confirm(`您正在尝试操作取消单据${row.orderNo}的重新竞价申请，确定取消吗？`, '提示', {

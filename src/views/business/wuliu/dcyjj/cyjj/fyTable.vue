<template>
  <div>
    <el-table
      ...
      <template v-if="auctionStatus === 3">
        <el-table-column prop="auctionStatusName" label="竞价状态" width="100"/>
      </template>
      ...
      <el-table-column prop="toUnit" label="收货单位" show-overflow-tooltip width="100"/>
...
export default {
  props: {
    ...
    auctionStatus: { type: Number, required: false, default: 0 }
  },
  data() {
    return {
